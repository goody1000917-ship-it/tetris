# 10 AI Image Prompts That Actually Go Viral

Source: [Long Live AI — Notion](https://longliveai.notion.site/10-AI-Image-Prompts-That-Actually-Go-Viral-38b20736b31380ab8c65e5db6e450ceb)

These prompts work well with **Nano Banana Pro** (Google Flow) and other modern image models. Upload a reference image, then paste the prompt.

## 分類總覽 / Categories

| 分類 | Prompts |
|------|---------|
| 🔧 照片強化 / Photo Enhancement | 1. 4K Effect · 2. Skin Enhancer |
| 🎮 場景風格轉換（保留人物）/ Scene Restyle (subject preserved) | 3. GTA Effect · 4. Minecraft Effect · 7. LEGO Effect |
| 🎨 藝術風格化 / Art Stylization | 6. MS Paint Effect · 10. Anime Effect |
| 💼 專業與商業 / Professional & Commercial | 5. Professional Portrait · 8. Product Ad |
| 🤳 社群與合成 / Social & Composite | 9. Group Selfie |

---

# 🔧 照片強化 / Photo Enhancement

## 1. 4K Effect

Makes your photo sharper, more detailed, and higher quality without changing anything about it. Recovers fine details and cleans up compressed images.
...
Professional skin enhancement retouch. Preserves original identity and structure. Refines skin texture naturally and maintains pores, freckles, and natural variations.
...
# 🎮 場景風格轉換（保留人物）/ Scene Restyle (subject preserved)

## 3. GTA Effect

Transforms any picture into a screenshot from Grand Theft Auto.
...
Transforms the setting of any image to Minecraft while preserving the human subject.
...
Transforms the setting of any image to look like it was built with LEGO pieces while preserving human subjects.
...
# 🎨 藝術風格化 / Art Stylization

## 6. MS Paint Effect

Transforms any picture to look like it was drawn with a computer mouse in Microsoft Paint.
...
Converts a photo into a detailed hand-drawn anime while maintaining original details.

**Prompt:**

> Anime style transformation. Convert the uploaded reference image into a high-quality 2D hand-drawn anime frame while preserving the exact composition, camera angle, framing, crop, perspective, pose, body proportions, object placement, and scene layout from the original image.
>
> Keep the image as a faithful anime adaptation of the reference, not a reimagined scene. Do not change the pose, expression, gaze direction, subject placement, clothing layout, background structure, camera distance, or overall visual arrangement.
>
> Translate all people into detailed anime characters while preserving their recognizable identity, facial structure, age, skin tone, hairstyle, body type, proportions, and expression. Use anime-proportional eyes that match the original face and gaze direction, not oversized generic anime eyes. Simplify the nose and mouth naturally while keeping the likeness accurate.
>
> Use clean 2D linework with controlled line weight, confident outlines, accurate anatomy, and sharp silhouette clarity. Render skin with smooth cel shading, soft tonal gradients, natural highlights, and lighting that matches the direction and intensity of the original image. Hair should become defined anime strands while preserving the original shape, flow, volume, and color.
>
> Convert clothing, accessories, objects, and environment into anime style while preserving their original shapes, colors, placement, and material feel. Keep folds, seams, logos, props, shadows, reflections, and small details accurate where visible.
>
> The background should become a believable anime environment with the same depth, perspective, lighting, atmosphere, and spatial layout as the reference image. Use clean background painting, subtle cel shading, gentle highlights, faithful colors, and polished modern anime production quality.
>
> The final image should look like a still frame from a high-quality anime film or premium anime series. High-fidelity adaptation rather than reinterpretation.
>
> Negative prompt: 3D render, CGI, game art, Pixar style, western comic style, watercolor painting, oil painting, semi-realistic digital painting, glossy AI art, over-smoothed faces, oversized generic anime eyes, changed identity, changed pose, changed camera angle, changed crop, changed outfit, distorted anatomy, broken limbs, extra fingers, warped hands, altered objects, missing background, simplified empty background, blurry linework, messy details, low-quality anime, generic character design.

---

# 💼 專業與商業 / Professional & Commercial

## 5. Professional Portrait

Converts any casual photo into a clean, polished studio headshot. Great for casting agencies, LinkedIn, etc.

**Prompt:**

> Image edit directive, convert the subject from the input photo into a clean professional studio headshot while preserving the exact clothing, hairstyle, and accessories from the original image. Studio portrait look. Tight head and shoulders framing, centered composition, neutral confident expression, eyes directly toward camera. Professional talent headshot aesthetic used by casting agencies and magazine profiles. Background minimal seamless light grey studio backdrop with soft falloff. No visible texture or environment. Lighting setup high end studio beauty lighting. Large soft key light slightly above eye level, centered but angled down. Soft fill from front to remove harsh shadows. Subtle rim light behind shoulders for separation. Even illumination across face with gentle shadow under jawline. Catchlights visible in both eyes. Camera perspective eye level. Shot on common 85mm portrait lens. Crisp focus on eyes, shallow depth of field so ears and shoulders fall slightly softer. Skin rendering realistic and professional. Natural pores visible, subtle skin texture, no plastic smoothing. Balanced color grading, neutral skin tones, clean contrast. Hair carefully groomed but natural. Individual strands visible. Clothing preserved exactly as in the source image with accurate fabric texture, folds, and color. Retouch level magazine professional but realistic. Remove temporary blemishes only keep natural facial structure, freckles, pores, and fine lines. Final look polished agency headshot. Neutral background, balanced lighting, symmetrical framing, professional studio finish.

---

## 8. Product Ad

Takes a product from your photo and turns it into a premium advertisement composition.
...
# 🤳 社群與合成 / Social & Composite

## 9. Group Selfie

Generates a casual iPhone selfie of two people from separate reference images.
...
1. Go to Google Flow → https://flow.google
2. Click **"Create with Google Flow"** and sign in
3. Go through the agreement pop-ups and click the **"+ New project"** button
4. Go through more pop-ups and click **"Get Started"**
5. Select **Nano Banana Pro** in the prompt box. Here you can select the aspect ratio your images generate in and how many images get generated each time you submit a prompt (1–4)

> Note: You only get a certain amount of free credits per day, so you can't generate unlimited images. But for casual use, this is really all you need.
